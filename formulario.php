<?php
 ...
 session_start();
    ...
    /*dados do solo*/
     ...
     if($proj_nome == "" && $proj_Tecnico_Responsavel == "" && $proj_CREA == "" && $proj_Proprietario == "" && $prop_nome == "" && $prop_endereco == "" && $prop_cep == "" && $prop_cidade == "" && $er == "" && $dta == "" && $ea == "" && $hf == "" && $tr == "" && $df == "" && $l ==  "" && $c == "" && $a_dnlp == "" && $a_dnll == "" && $a_clr == "" && $a_cls == "" && $a_dnlr == "" && $a_dnls == "" && $tf == "" && $a_nts == "" && $nome_cultura == "" && $data == "" && $eep == "" && $eef == "" && $as == "" && $pesr == "" && $fd == "" && $cc == "" && $ec == "" || $proj_nome == "" || $proj_Tecnico_Responsavel == "" || $proj_CREA == "" || $proj_Proprietario == "" || $prop_nome == "" || $prop_endereco == "" || $prop_cep == "" || $prop_cidade == "" || $er == "" || $dta == "" || $ea == "" || $hf == "" || $tr == "" || $df == "" || $l ==  "" || $c == "" || $a_dnlp == "" || $a_dnll == "" || $a_clr == "" || $a_cls == "" || $a_dnlr == "" || $a_dnls == "" || $tf == "" || $a_nts == "" || $nome_cultura == "" || $data == "" || $eep == "" || $eef == "" || $as == "" || $pesr == "" || $fd == "" || $cc == "" || $ec == ""){
