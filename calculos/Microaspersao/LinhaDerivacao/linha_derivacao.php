		...
		<div id="contentWrapper">
            ...
            <form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="ld.php" >
				...
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Vazão da Linha Lateral (l/s)</label><input type="text" class="form-control " name='vazao_l_l' id="vazao_l_l" placeholder='Vazão da Linha Lateral (l/s)'/>
				</div>
