...
<div id="wrapper">
	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<div id="news">
                        <h1><center>Lâmina de Irrigação Ajustada</center></h1>
						
				<br><br>
						
		<form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="lia.php" >
						
			<fieldset>			
			
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Turno de Rega Adotado</label><input type="text" class="form-control " name='Turno_de_Rega_Adotado' id="Turno_de_Rega_Adotado" placeholder='Turno de Rega Adotado'/>
				</div>
				
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">ETc loc</label><input type="text" class="form-control " name='ETcloc' id="ETcloc" placeholder='ETc loc'/>
				</div>		
