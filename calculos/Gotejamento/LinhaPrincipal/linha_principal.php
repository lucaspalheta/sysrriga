...
<div id="wrapper">
	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<div id="news">
                        <h1><center>Linha Principal</center></h1>
						
				<br><br>
						
             <form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="lp.php" >
						
			<fieldset> 
			
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Vazão da Linha de Derivação</label><input type="text" class="form-control " name='vazaold' id="vazaold" placeholder='Vazão da Linha de Derivação'/>
				</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Número de Linhas de Derivação</label><input type="text" class="form-control " name='numerold' id="numerold" placeholder='Número de Linhas de Derivação'/>
					</div>
			
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
					<label class="control-label color_black">Comprimento da Área</label><input type="text" class="form-control" name='ComprimentoA' id="ComprimentoA"  placeholder='Comprimento da Área' />
				</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Diferença de Nível da Área</label><input type="text" class="form-control " name='direnca_nivel_a' id="direnca_nivel_a" placeholder='Diferença de Nível da Área' />
				</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Velocidade Máxima</label><input type="text" class="form-control " name='Velocidade_Maxima_da_Linha_Principal' id="Velocidade_Maxima_da_Linha_Principal" placeholder='Velocidade Máxima da Linha Principal'/>
				</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Coeficiente de Rugosidade</label><input type="text" class="form-control " name='Coeficiente_de_Rugosidade_da_Linha_Principal' id="Coeficiente_de_Rugosidade_da_Linha_Principal" placeholder='Coeficente de Ruigosidade da Linha Principal		'/>
					</div>
				
                <div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
					<label class="control-label color_black">Comprimento da Linha Principal</label><input type="text" class="form-control" name='Comprimento' id="Comprimento"  placeholder='Comprimento da Linha Principal' />
				</div>				
				...
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						...
						<select class="form-control" name="materiallp" placeholder='Material (DN/PN)'>
