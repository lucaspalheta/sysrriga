	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<fieldset>
				...
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Coeficiente da Linha Lateral (Cg)</label><input type="text" class="form-control " name='Cg_da_Linha_Lateral' id="Cg_da_Linha_Lateral" placeholder='Cg da Linha Lateral'/>
			    </div>
