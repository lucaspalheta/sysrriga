...
<div id="wrapper">
	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<div id="news">
                        <h1><center>Linha de Derivação</center></h1>
						
				<br><br>
						
			<form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="ld.php" >
						
			<fieldset> 
			
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Vazão da Linha Lateral (l/s)</label><input type="text" class="form-control " name='vazaoll' id="vazaoll" placeholder='Vazão da Linha Lateral'/>
				</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Número de Saídas</label><input type="text" class="form-control " name='numero_s_ld' id="numero_s_ld" placeholder='Número de Linhas de Derivação'/>
					</div>
			
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
					<label class="control-label color_black">Comprimento</label><input type="text" class="form-control" name='Comprimento' id="Comprimento"  placeholder='Comprimento' />
				</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Diferença de Nível - Linha Principal</label><input type="text" class="form-control " name='direnca_nivel_lp' id="direnca_nivel_lp" placeholder='Diferença de Nível - Linha Principal' />
				</div>
			
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">hf Admissível</label><input type="text" class="form-control " name='hf_Admissivel' id="hf_Admissivel" placeholder='hf Admissível'/>
					</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Pressão de Serviço</label><input type="text" class="form-control " name='microaspersor_pressao_de_servico' id="microaspersor_pressao_de_servico" placeholder='Pressão de Serviço'/>
					</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Cg</label><input type="text" class="form-control " name='Cg_da_Linha_de_Derivacao' id="Cg_da_Linha_de_Derivacao" placeholder='Cg da Linha de Dericação'/>
			    </div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">F</label><input type="text" class="form-control " name='F_Linha_de_Derivacao' id="F_Linha_de_Derivacao" placeholder='F de derivação'/>
				</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">

						<label class="control-label color_black">Diâmetro do Nivel da Linha de Derivção</label>
						
						<select class="form-control" name="diametro_nivel_ld" placeholder='diametro_nivel_ld'>
				...
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Pressão de Início da Linha Lateral</label><input type="text" class="form-control " name='Pressao_de_Inicio_da_Linha_Lateral' id="Pressao_de_Inicio_da_Linha_Lateral" placeholder='Pressão de Início da Linha Lateral'/>
				</div>
