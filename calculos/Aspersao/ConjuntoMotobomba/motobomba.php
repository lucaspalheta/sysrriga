...
<div id="wrapper">
	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="cmb.php" >
			...
			<fieldset>
				...
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Vazão Total da Linha Lateral em l/s</label><input type="text" class="form-control " name='vazao_ll' id="vazao_ll" placeholder='Vazão Total da Linha Lateral em l/s'/>
				</div>
