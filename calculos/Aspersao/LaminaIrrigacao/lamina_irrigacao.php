		...
		<div id="contentWrapper">
			...
			<div id="news">
		      ...
		      <form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="li.php" >					
				...
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">ETc</label><input type="text" class="form-control " name='ETcloc' id="ETcloc" placeholder='ETc loc'/>
				</div>
				
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Dias de Folga</label><input type="text" class="form-control " name='dias' id="dias" placeholder='Dias de Folga'/>
				</div>
