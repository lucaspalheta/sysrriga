...
<div id="wrapper">
	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<div id="news">
                        <h1><center>Linha de Recalque</center></h1>
						
				<br><br>
						
		     <form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="lr.php" >
		
			<fieldset> 
			
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Vazão da Linha de Recalque</label><input type="text" class="form-control " name='Vazao_da_Linha_de_Recalque' id="Vazao_da_Linha_de_Recalque" placeholder='Vazão da Linha de Recalque'/>
					</div>
					
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Velocidade Máxima</label><input type="text" class="form-control " name='Velocidade_Maxima_da_Linha_de_Recalque' id="Velocidade_Maxima_da_Linha_de_Recalque" placeholder='Velocidade Máxima da Linha de Recalque'/>
					</div>
					
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Coeficiente de Rugosidade</label><input type="text" class="form-control " name='Coeficiente_de_Rugosidade_da_Linha_de_Recalque' id="Coeficiente_de_Rugosidade_da_Linha_de_Recalque" placeholder='Coeficente de Ruigosidade da Linha de Recalque		'/>
					</div>
					
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Comprimento</label><input type="text" class="form-control " name='Comprimento_da_Linha_de_Recalque' id="Comprimento_da_Linha_de_Recalque" placeholder='Comprimento'/>
					</div>
               
                	<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Diferença de Nível</label><input type="text" class="form-control " name='dn' id="dn" placeholder='Diferença de Nível'/>
					</div>
					...
					<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						...
						<select class="form-control" name="materiallr" placeholder='Material (DN/PN)'>
