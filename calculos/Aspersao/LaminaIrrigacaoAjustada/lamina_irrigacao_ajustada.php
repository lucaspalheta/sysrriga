		...
		<div id="contentWrapper">
			...
			<form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="lia.php" >
				...
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">ETc</label><input type="text" class="form-control " name='ETcloc' id="ETcloc" placeholder='ETc'/>
				</div>
					
				<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Turno de Rega Adotado</label><input type="text" class="form-control " name='Turno_de_Rega_Adotado' id="Turno_de_Rega_Adotado" placeholder='Turno de Rega'/>
				</div>
