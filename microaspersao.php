...
<div id="wrapper">
	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<div id="news">
				<center><h1>Dados do Microaspersor</h1></center>

                       <br><br>

		<form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="dados_microaspersor.php" >
						
                    <fieldset >
					<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Vazão do Emissor</label><input type="text" class="form-control " name='vazao_do_emissor' id="vazao_do_emissor" placeholder='Vazão do Emissor'/>
					</div>
					<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
					...
					<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Percentagem de Área Molhada</label><input type="text" class="form-control " name='percentagem_de_area_molhada' id="percentagem_de_area_molhada" placeholder='Percentagem de Área Molhada'/>
					</div>
					<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Número de Emissores por Planta</label><input type="text" class="form-control " name='numero_de_emissores_por_planta' id="numero_de_emissores_por_planta" placeholder='Número de Emissores por Planta'/>
					</div>
					<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
					...
					<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Espaçamento entre Emissores</label><input type="text" class="form-control " name='espacamento_entre_emissores' id="espacamento_entre_emissores" placeholder='Espaçamento entre Emissores'/>
					</div>
					<div class="form-group col-md-3 col-sm-12 col-xs-12 evapotranspiracao">
