	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<div id="news">
				...
				<center><h1> Excluir Usuário </h1><hr></center> 
				
				<form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="exc_usuario.php" >
				...
				<fieldset> 
				 ...
				 <br><br>
					...
					<center><button type="submit" id="cadastro_btn" class="myButton">Excluir</button></center>
				<br><br>
