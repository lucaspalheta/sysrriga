	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<div id="news">
				...
				<center><h1> Dados dos Usuários </h1><hr></center> 
                   ...
                   $linhas = mysql_num_rows($resultado);
                        for($i = 0; $i < $linhas; $i++){
                         $registro = mysql_fetch_row($resultado);
							...
							echo "<h3>&nbsp&nbsp&nbsp ID do Usuário: $registro[0]</h3>";
							echo "<h3>&nbsp&nbsp&nbsp Nome do Usuário: $registro[1]</h3>";
							echo "<h3>&nbsp&nbsp&nbsp Email do Usuário: $registro[2] </h3><br/>";
