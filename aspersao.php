...
<div id="wrapper">
	...
	<div id="rightWrapper">
		...
		<div id="contentWrapper">
			...
			<div id="news">
			<center><h1>Características do Aspersor</h1></center>

                       <br><br>
                <form class="container form-horizontal  form-border "  id="formulario_total" role="form" method="post" action="dados_aspersor.php">
				
					<fieldset>	
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 evapotranspiracao ">
						<label class="control-label color_black">Nome</label><input type="text" class="form-control" name='name' placeholder='Nome'/>
					</div>
					
					<div class="form-group col-md-12 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Marca</label><input type="text" class="form-control" name='Marca' placeholder='Marca'/>
					</div>
					
					<div class="form-group col-md-12 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Pressão de Serviço</label><input type="text" class="form-control" name='Pressao_de_Servico' placeholder='Pressão de Serviço'/>
					</div>
					
					<div class="form-group col-md-12 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Vazão</label><input type="text" class="form-control" name='Vazao' placeholder='Vazão'>
					</div>
					
					<div class="form-group col-md-12 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Coeficiente de Descarga</label><input type="text" class="form-control" name='Coeficiente_de_descarga' placeholder='Coeficiente de Descarga'>
					</div>
					
					<div class="form-group col-md-12 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Área dos Bocais</label><input type="text" class="form-control" name='Area_dos_bocais' placeholder='Área dos Bocais'>
					</div>
					
					<div class="form-group col-md-12 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Espaçamento dos Aspersores</label><input type="text" class="form-control" name='Espacamento_dos_Apersores' placeholder='Espaçamento dos Aspersores'>
					</div>
					
					<div class="form-group col-md-12 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Espaçamento entre Aspersores</label><input type="text" class="form-control" name='Espacamento_entre_aspersores' placeholder='Espaçamento entre Aspersores'>
					</div>
					
					<div class="form-group col-md-12 col-sm-12 col-xs-12 evapotranspiracao">
						<label class="control-label color_black">Espaçamento entre Linhas Laterais</label><input type="text" class="form-control" name='Espacamento_entre_Linhas_Laterais' placeholder='Espaçamento entre Linhas Laterais'>
					</div>
